            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-cogs" aria-hidden="true"></i> Users <span class="fa fa-chevron-down"></span></a>
                     <ul class="nav child_menu">
                      <li class="sub_menu"><a href="{{route('admin.registration_form')}}">Add Delivery Boy</a></li>
                      <li class="sub_menu"><a href="{{route('admin.user_list')}}">Delivery Boy List</a></li>
                    </ul>
                  </li>
                  ...
                  <li><a><i class="fa fa-cogs" aria-hidden="true"></i> Configuration <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                     <li class="sub_menu"><a href="{{route('admin.beat_list')}}">Beat Name List</a></li>
                     <li class="sub_menu"><a href="{{route('admin.outlet_list')}}">Outlet List</a></li>                     
                     <li class="sub_menu"><a href="{{route('admin.vehicle_list')}}">Vehicle List</a></li>
                   </ul>
                 </li>
